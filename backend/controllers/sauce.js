 ...
 * supprime l'userID de la requête (par sécurité pour empêcher quelqu'un de modifier/supprimer un objet qui n'est pas le sien)
...
/**
 * sauceObjet = récupère les modifications effectuée en indiquant le nom d'hote (dossier image)
 * Supression du champ _userId envoyé par le client afin d’éviter de changer son propriétaire et nous avons vérifié que le requérant est bien le propriétaire de l’objet
 ...
 * Vérification : si l'’utilisateur qui a fait la requête de suppression est bien celui qui a créé lsa sauce
